...
const Home = () => {
  ...
  const [currentSection, setCurrentSection] = useState(0); // Initialize currentSection

  useEffect(() => {
    const handleResize = () => {
      setIsMobile(window.innerWidth <= 768); // Check if mobile screen
    };
